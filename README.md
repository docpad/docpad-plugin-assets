...
As an added bonus, this plugin will also minify any assets which it identifies as Javascript files.  To disable this feature you can set the option 'minifyJS' to 'no'.
